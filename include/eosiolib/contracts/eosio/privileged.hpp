...
namespace eosio {
   ...
   namespace internal_use_do_not_use {
      extern "C" {
        ...
        /*ultra-adam---modification for ram strategy---start */
        __attribute__((eosio_wasm_import))
        void get_account_ram_usage( uint64_t account, int64_t* ram_usage );
        /*ultra-adam---modification for ram strategy---end */

        /*ultra-nsjames---UB-250 CPU/NET strategy 2.0 --- */
        __attribute__((eosio_wasm_import))
        void get_account_power_usage( uint64_t account, int64_t* power_usage );

        /*ultra-nsjames--- ub252 ranked transaction queue --- */
        __attribute__((eosio_wasm_import))
        void set_tx_ranking_algorithm( const uint32_t* algorithm );
   ...
   */
   ...
   struct blockchain_parameters {
      ...
      */
      ...
      /*ultra-adam---UB-84 ultra account---start */
      uint8_t ultra_veto_enabled;
      /*ultra-adam---UB-84 ultra account---end */
      ...
      */
      ...
      EOSLIB_SERIALIZE( blockchain_parameters,
                        ...
                        /*ultra-adam---UB-84 ultra account---start/end */
                        (ultra_veto_enabled)
   ...
   inline void set_resource_limits( name account, int64_t ram_bytes, int64_t net_weight, int64_t cpu_weight ) {
    ...
    /*ultra-adam---modification for ram strategy---start */
    inline void get_account_ram_usage( name account, int64_t& ram_usage ) {
      internal_use_do_not_use::get_account_ram_usage( account.value, &ram_usage );
    }
    /*ultra-adam---modification for ram strategy---end */

    /*ultra-nsjames---UB-250 CPU/NET strategy 2.0 --- */
    inline void get_account_power_usage( name account, int64_t& power_usage ) {
      internal_use_do_not_use::get_account_power_usage( account.value, &power_usage );
    }

    /*ultra-nsjames--- ub252 ranked transaction queue --- */
    inline void set_tx_ranking_algorithm( const uint32_t& algorithm ) {
      internal_use_do_not_use::set_tx_ranking_algorithm( &algorithm );
    }
