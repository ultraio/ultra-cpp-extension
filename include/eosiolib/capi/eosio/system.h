 ...
 *  @param test - 0 to abort, 1 to ignore
 *  @param code - the error code
 *  @param name - a pointer to the start of string defining the name of the exception
 *  @param what - a pointer to the start of string explaining the reason for failure
 *  @param msg - a pointer to the start of string detailing the reason and conditions of failure
 */
__attribute__((eosio_wasm_import))
