...
// ultra-adam
/*ultra-nsjames---UB-250 CPU/NET strategy 2.0 [get_account_power_usage] --- */
/*ultra-nsjames--- ub252 ranked transaction queue [set_tx_ranking_algorithm] --- */
/*ultra-nsjames --- UB-634 expose string to public key [string_to_public_key] */
...
intrinsic_macro(get_account_power_usage) \
intrinsic_macro(set_tx_ranking_algorithm) \
...
intrinsic_macro(string_to_public_key) \
